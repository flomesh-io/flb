/*
 *  flb_dp_cdefs.h: FLB eBPF/XDP utility functions 
 *  Copyright (C) 2022,  Flomesh <www.flomesh.io>
 * 
 * SPDX-License-Identifier: (GPL-2.0 OR BSD-2-Clause)
 */
#ifndef __FLB_DP_CDEFS_H__
#define __FLB_DP_CDEFS_H__
...
#include "../common/flb_dp_mdi.h"
#include "../common/flb_dpapi.h"
...
struct bpf_map_def SEC("maps") intf_map = {
  ...
  .max_entries = FLB_INTF_MAP_ENTRIES,
...
struct bpf_map_def SEC("maps") smac_map = {
  ...
  .max_entries = FLB_SMAC_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") dmac_map = {
  ...
  .max_entries = FLB_DMAC_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") tmac_map = {
  ...
  .max_entries = FLB_TMAC_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") nh_map = {
  ...
  .max_entries = FLB_NH_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") ct_map = {
  ...
  .max_entries = FLB_CT_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") nat_map = {
  ...
  .max_entries = FLB_NATV4_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") nat_stats_map = {
  ...
  .key_size = sizeof(__u32),  /* Counter Index */
  .value_size = sizeof(struct dp_pb_stats),
  .max_entries = FLB_NATV4_STAT_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") rt_v4_map = {
  ...
  .max_entries = FLB_RTV4_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") rt_v6_map = {
  ...
  .value_size = sizeof(struct dp_rt_tact),
  .map_flags = BPF_F_NO_PREALLOC,
  .max_entries = FLB_RTV6_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") mirr_map = {
  ...
  .max_entries = FLB_MIRR_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") sess_v4_map = {
  ...
  .map_flags = BPF_F_NO_PREALLOC,
  .max_entries = FLB_SESS_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") fc_v4_map = {
  ...
  .value_size = sizeof(struct dp_fc_tacts),
  .map_flags = BPF_F_NO_PREALLOC,
  .max_entries = FLB_FCV4_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") fw_v4_map = {
  ...
  .max_entries = FLB_FW4_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") pgm_tbl = {
  ...
  .key_size = sizeof(__u32),
  .value_size = sizeof(__u32),
  .max_entries =  FLB_PGM_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};
...
struct bpf_map_def SEC("maps") polx_map = { 
  ...
  .max_entries =  FLB_POL_MAP_ENTRIES,
  .pinning = PIN_GLOBAL_NS
}; 
...
struct bpf_map_def SEC("maps") crc32c_map = {
  .type = BPF_MAP_TYPE_ARRAY,
  .key_size = sizeof(__u32),
  .value_size = sizeof(__u32),
  .max_entries = LLB_CRC32C_ENTRIES,
  .pinning = PIN_GLOBAL_NS
};

struct bpf_map_def SEC("maps") cpu_map = {
  .type = BPF_MAP_TYPE_CPUMAP,
  .key_size = sizeof(__u32),  /* Index CPU idx */
  .value_size = sizeof(__u32),
  .max_entries = MAX_CPUS,
  .pinning = PIN_GLOBAL_NS
};

struct bpf_map_def SEC("maps") live_cpu_map = {
  .type = BPF_MAP_TYPE_ARRAY,
  .key_size = sizeof(__u32),  /* Index CPU idx */
  .value_size = sizeof(__u32),
  .max_entries = MAX_CPUS,
...
struct {
        ...
        __uint(max_entries, FLB_INTERFACES);
...
struct {
        ...
        __type(key,         __u32);
        __type(value,       struct dp_pb_stats);
        __uint(max_entries, FLB_INTF_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
...
struct {
        ...
        __uint(max_entries, FLB_SMAC_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} smac_map SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_DMAC_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} dmac_map SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_TMAC_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} tmac_map SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_NH_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} nh_map SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_CT_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} ct_map SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_NATV4_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} nat_map SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_RTV4_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} rt_v4_map SEC(".maps");
...
struct {
        ...
        __type(key,         __u32);
        __type(value,       struct dp_pb_stats);
        __uint(max_entries, FLB_RTV6_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
...
struct {
        ...
        __uint(max_entries, FLB_MIRR_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} mirr_map SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_SESS_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
...
struct {
        ...
        __type(value,       struct dp_fc_tacts);
        __uint(max_entries, FLB_FCV4_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} fc_v4_map SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_FW4_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} fw_v4_map SEC(".maps");
...
struct {
        ...
        __type(key,         __u32);
        __type(value,       __u32);
        __uint(max_entries, FLB_PGM_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} pgm_tbl SEC(".maps");
...
struct {
        ...
        __uint(max_entries, FLB_POL_MAP_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} polx_map SEC(".maps");
...
struct {
        ...
        __type(key,         __u32);
        __type(value,       __u32);
        __uint(max_entries, FLB_CRC32C_ENTRIES);
        __uint(pinning,     LIBBPF_PIN_BY_NAME);
} crc32c_map SEC(".maps");
...
#define DP_FLB_STAMP(md) (((struct __sk_buff *)md)->cb[0] = FLB_PIPE_STAMP_FLAG)
#define DP_FLB_RST_STAMP(md) (((struct __sk_buff *)md)->cb[0] = 0)
#define DP_FLB_STAMPED(md) (((struct __sk_buff *)md)->cb[0] == FLB_PIPE_STAMP_FLAG)
#define DP_FLB_IS_EGR(md) ((((struct __sk_buff *)md)->ingress_ifindex) != (((struct __sk_buff *)md)->ifindex))
#define DP_FLB_INIFIDX_NONE(md) (((struct __sk_buff *)md)->ingress_ifindex == 0)
#define DP_FLB_EGRESS_HOOK(md) (DP_FLB_STAMPED(md) || DP_FLB_INIFIDX_NONE(md))
#define DP_NEED_MIRR(md) (((struct __sk_buff *)md)->cb[0] == FLB_MIRR_MARK)
#define DP_GET_MIRR(md) (((struct __sk_buff *)md)->cb[1])
#define DP_CTX_MIRR(md) (((struct __sk_buff *)md)->cb[0] == FLB_MIRR_MARK)
  ...
  if (xf->pm.pten) {                     \
    if (xf->pm.pten == DP_PTEN_ALL ||    \
       ((xf->pm.pten == DP_PTEN_TRAP) && \
        (xf->pm.pipe_act & FLB_PIPE_EXCP_MASK))) { \
...
do {                                             \
  xf->pm.phit |= FLB_DP_RES_HIT;                 \
  bpf_tail_call(ctx, &pgm_tbl, FLB_DP_CT_PGM_ID);\
  return DP_PASS;                                \
} while(0)

#define TCALL_CRC1() bpf_tail_call(ctx, &pgm_tbl, FLB_DP_CRC_PGM_ID1)
#define TCALL_CRC2() bpf_tail_call(ctx, &pgm_tbl, FLB_DP_CRC_PGM_ID2)
...
dp_sunp_tcall(void *ctx,  struct xfi *xf)
{
  ...
  bpf_map_update_elem(&xfis, &z, xf, BPF_ANY);
  bpf_tail_call(ctx, &pgm_tbl, FLB_DP_SUNP_PGM_ID2);
...
dp_do_dnat(void *ctx, struct xfi *xf, __be32 xip, __be16 xport)
{
  ...
  if (xf->l34m.nw_proto == IPPROTO_TCP)  {
    ...
    if (tcp + 1 > dend) {
      FLBS_PPLN_DROPC(xf, FLB_PIPE_RC_PLERR);
      return -1;
    }
...
dp_do_dnat64(void *md, struct xfi *xf)
{
  ...
  if (bpf_skb_change_proto(md, bpf_htons(ETH_P_IP), 0) < 0) {
    FLBS_PPLN_DROPC(xf, FLB_PIPE_RC_PROTO_ERR);
    return -1;
  }
...
#define DP_FLB_STAMP(md)
#define DP_FLB_RST_STAMP(md)
#define DP_FLB_STAMPED(md) (0)
#define DP_FLB_EGRESS_HOOK(md) (0)
#define DP_FLB_INIFIDX_NONE(md) (0)
#define DP_FLB_IS_EGR(md) (0)

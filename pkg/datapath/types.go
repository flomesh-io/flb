...
const (
	LLB_MAX_LB_NODES           = C.LLB_MAX_LB_NODES
	LLB_MIRR_MAP_ENTRIES       = C.LLB_MIRR_MAP_ENTRIES
	LLB_NH_MAP_ENTRIES         = C.LLB_NH_MAP_ENTRIES
	LLB_RTV4_MAP_ENTRIES       = C.LLB_RTV4_MAP_ENTRIES
	LLB_RTV4_PREF_LEN          = C.LLB_RTV4_PREF_LEN
	LLB_CT_MAP_ENTRIES         = C.LLB_CT_MAP_ENTRIES
	LLB_ACLV6_MAP_ENTRIES      = C.LLB_ACLV6_MAP_ENTRIES
	LLB_RTV6_MAP_ENTRIES       = C.LLB_RTV6_MAP_ENTRIES
	LLB_TMAC_MAP_ENTRIES       = C.LLB_TMAC_MAP_ENTRIES
	LLB_DMAC_MAP_ENTRIES       = C.LLB_DMAC_MAP_ENTRIES
	LLB_NATV4_MAP_ENTRIES      = C.LLB_NATV4_MAP_ENTRIES
	LLB_NATV4_STAT_MAP_ENTRIES = C.LLB_NATV4_STAT_MAP_ENTRIES
	LLB_SMAC_MAP_ENTRIES       = C.LLB_SMAC_MAP_ENTRIES
	LLB_FW4_MAP_ENTRIES        = C.LLB_FW4_MAP_ENTRIES
	LLB_INTERFACES             = C.LLB_INTERFACES
	LLB_PORT_NO                = C.LLB_PORT_NO
	LLB_PORT_PIDX_START        = C.LLB_PORT_PIDX_START
	LLB_INTF_MAP_ENTRIES       = C.LLB_INTF_MAP_ENTRIES
	LLB_FCV4_MAP_ENTRIES       = C.LLB_FCV4_MAP_ENTRIES
	LLB_PGM_MAP_ENTRIES        = C.LLB_PGM_MAP_ENTRIES
	LLB_FCV4_MAP_ACTS          = C.LLB_FCV4_MAP_ACTS
	LLB_POL_MAP_ENTRIES        = C.LLB_POL_MAP_ENTRIES
	LLB_SESS_MAP_ENTRIES       = C.LLB_SESS_MAP_ENTRIES
	LLB_PSECS                  = C.LLB_PSECS
	LLB_MAX_NXFRMS             = C.LLB_MAX_NXFRMS
	LLB_CRC32C_ENTRIES         = C.LLB_CRC32C_ENTRIES
	LLB_MAX_MHOSTS             = C.LLB_MAX_MHOSTS
	LLB_MAX_MPHOSTS            = C.LLB_MAX_MPHOSTS
)

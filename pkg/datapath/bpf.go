...
// func Demo() {
// 	//fmt.Println(C.GoString(C.xh.ll_dp_pdir))

// 	// for i := 0; i < C.LL_DP_MAX_MAP; i++ {
// 	// 	fmt.Println(xh.maps[i].map_name)
// 	// }

// 	// info, _ := xh.maps[LL_DP_INTF_MAP].emap.Info()
// 	// id, _ := info.ID()
// 	// fd := bpf_map_get_fd_by_id(uint32(id))
// 	// //fd := xh.maps[LL_DP_INTF_MAP].map_fd
// 	// fmt.Println("fd:", fd)
// 	// var key *dp_intf_key
// 	// nextkey := new(dp_intf_key)
// 	// data := new(dp_intf_tact)
// 	// for bpf_map_get_next_key(fd, unsafe.Pointer(key), unsafe.Pointer(nextkey)) == 0 {
// 	// 	key = nextkey
// 	// 	fmt.Println(nextkey.ifindex)
// 	// 	bpf_map_lookup_elem(fd, unsafe.Pointer(nextkey), unsafe.Pointer(data))
// 	// 	fmt.Println(data.ca.act_type)
// 	// }
// }
